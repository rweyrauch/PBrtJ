...
public class HgTest {
    ...
    @Test
    public void testHenyeyGreensteinSamplingMatch() {
        RNG rng = new RNG(0);
    ...
    @Test
    public void testHenyeyGreensteinSamplingOrientationForward() {
        RNG rng = new RNG(0);
    ...
    @Test
    public void testHenyeyGreensteinSamplingOrientationBackward() {
        RNG rng = new RNG(0);
    ...
    @Test
    public void testHenyeyGreensteinNormalized() {
        RNG rng = new RNG(0);
        for (float g = -0.75f; g <= 0.75f; g += 0.25f) {
            HenyeyGreenstein hg = new HenyeyGreenstein(g);
            Vector3f wo = Sampling.UniformSampleSphere(new Point2f(rng.UniformFloat(), rng.UniformFloat()));
